...
class OwnerScreen extends StatefulWidget {
  final User user;
  const OwnerScreen({super.key, required this.user, required seller});
...
class _OwnerScreenState extends State<OwnerScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          appBar: AppBar(title: const Text("Owner"), actions: [
            IconButton(
                    ...
                    Expanded(
                      child: GridView.count(
                        ...
                        children: List.generate(homestayList.length, (index) {
                          String price =
                              homestayList[index].homestayPrice?.toString() ??
                                  "";
                          return Card(
                            elevation: 8,
                            child: InkWell(
                              ...
                              child: Column(children: [
                                ...
                                Flexible(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    fit: BoxFit.cover,
                                    imageUrl:
                                        "${ServerConfig.SERVER}/assets/roomimages/${homestayList[index].homestayId}.png",
